...
const char indexedTriangleSetNodeString[] = "IndexedTriangleSet";
const char indexedTriangleFanSetNodeString[] = "IndexedTriangleFanSet";
const char indexedTriangleStripSetNodeString[] = "IndexedTriangleStripSet";
...
const char indexFieldString[] = "index";
